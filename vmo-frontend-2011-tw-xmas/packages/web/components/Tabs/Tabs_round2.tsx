...
import { Tabs_round2TimeState, Iframes, TrackTab } from '@vmo/web/constants/config';
...
import { sortTab210 } from '@vmo/ui/hooks/api/sort';
...
const getCondition = (team, scores) => {
  ...
  switch (rank) {
    case 0: {
      return Conditions.rank321xx;
    }
    case 1: {
      return Conditions.rank322xx;
    }
    case 2: {
      return Conditions.rank323xx;
    }
    case -1:
    default: {
...
const Tabs_round2 = () => {
  ...
  const Tabs_round2Items = [
    {
        tabKey: Tabs_round2TimeState[0].tabKey,
        title: (
          <div>
        ...
        eventIntro: {
          ...
          iframe: Iframes.methods.t7,
        },
        countdown: {
            startDate: Tabs_round2TimeState[0].startDate,
            endDate: Tabs_round2TimeState[0].endDate,
            dateFormat: 'MM/d (WN) hh:mm:ss',
            formatStr: translation.get('COUNTDOWN_COUNTING'),
          },
        // rankTitle: translation.get('offlineNT_INTRO_TITLE'),
        leaderboard: {
            apis:[api.offline.r2.g1, api.offline.r2.g2, api.offline.r2.g3],
            team: 'sock',
            sortFunc: sortTab210,
      ...
      {
        tabKey: Tabs_round2TimeState[1].tabKey,
        title: (
          <div>
        ...
        countdown: {
            startDate: Tabs_round2TimeState[1].startDate,
            endDate: Tabs_round2TimeState[1].endDate,
            dateFormat: 'MM/d (WN) hh:mm:ss',
            formatStr: translation.get('COUNTDOWN_COUNTING'),
          },
        // rankTitle: translation.get('offlineNT_INTRO_TITLE'),
      ...
      {
        tabKey: Tabs_round2TimeState[2].tabKey,
        title: (<div>
        ...
        countdown: {
            startDate: Tabs_round2TimeState[2].startDate,
            endDate: Tabs_round2TimeState[2].endDate,
            dateFormat: 'MM/d (WN) hh:mm:ss',
            formatStr: translation.get('COUNTDOWN_COUNTING'),
          },
        // rankTitle: translation.get('offlineNT_INTRO_TITLE'),
  ...
  const defaultTabIndex = getDefaultDay(Tabs_round2TimeState, 0);
  return (
    
    <Tabs_round1Styled active={Tabs_round2TimeState[defaultTabIndex].tabKey}>
      {Tabs_round2Items.map(item => (
        <Tab
